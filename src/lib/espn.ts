...
const leagues: EspnLeague[] = [
  ...
  { path: "tennis/atp", league: "ATP Tour", sport: "Tenis", importance: 88, adapter: "tennis" },
  { path: "tennis/wta", league: "WTA Tour", sport: "Tenis", importance: 86, adapter: "tennis" },
  { path: "racing/f1", league: "Fórmula 1", sport: "Automovilismo", importance: 94, adapter: "racing" },
  { path: "racing/irl", league: "IndyCar", sport: "Automovilismo", importance: 82, adapter: "racing" },
  { path: "racing/nascar-premier", league: "NASCAR Cup Series", sport: "Automovilismo", importance: 82, adapter: "racing" },
  { path: "mma/ufc", league: "UFC", sport: "MMA", importance: 91, adapter: "combat" },
  { path: "mma/pfl", league: "PFL", sport: "MMA", importance: 80, adapter: "combat" },
  { path: "mma/bellator", league: "Bellator", sport: "MMA", importance: 78, adapter: "combat" },
  { path: "golf/pga", league: "PGA Tour", sport: "Golf", importance: 82, adapter: "golf" },
  { path: "golf/eur", league: "DP World Tour", sport: "Golf", importance: 78, adapter: "golf" },
  { path: "golf/liv", league: "LIV Golf", sport: "Golf", importance: 78, adapter: "golf" },
  { path: "golf/lpga", league: "LPGA", sport: "Golf", importance: 78, adapter: "golf" },
  { path: "golf/champions-tour", league: "PGA Champions Tour", sport: "Golf", importance: 70, adapter: "golf" },
];
...
function mapTennisEvent(event: EspnEvent, league: EspnLeague, range: string): SportsEvent[] {
  ...
  return groups.flatMap((group) => (group.competitions || []).flatMap((competition) => {
    ...
    const item: SportsEvent = {
      ...
      country: venue?.address?.country || venue?.address?.city || undefined,
      broadcasts: normalizeBroadcasts(competition.broadcasts),
      importance: event.major ? Math.max(95, league.importance) : league.importance,
      featured: Boolean(event.major),
      source: "espn",
      sourceEventId: event.id,
